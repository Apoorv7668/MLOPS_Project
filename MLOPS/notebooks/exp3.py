...
mlflow.set_tracking_uri("https://dagshub.com/Apoorv7668/MLOPS_Project.mlflow") # URL to track the experiment

# Load the dataset from a CSV file
# data = pd.read_csv("C:\Users/Dell/Downloads/archive (1)/water_potability.csv")
data = pd.read_csv(r"C:\Users\Dell\Downloads\archive (1)\water_potability.csv")
